...
class TweetNaClCryptoBoxCurve25519XSalsa20Poly1305Test < MiniTest::Test
  def test_crypto_box_curve25519xsalsa20poly1305
    ...
    cipher = TweetNaCl.crypto_box_curve25519xsalsa20poly1305(input, nonce, pk, sk)

    output = TweetNaCl.crypto_box_curve25519xsalsa20poly1305_open(cipher, nonce, pk, sk)
  ...
  def test_crypto_box_curve25519xsalsa20poly1305_require_message_to_cipher
    set = false
    begin
      TweetNaCl.crypto_box_curve25519xsalsa20poly1305(nil, "bar", "pk", "sk")
  ...
  def test_crypto_box_curve25519xsalsa20poly1305_require_public_key
    set = false
    begin
      TweetNaCl.crypto_box_curve25519xsalsa20poly1305("foo", "bar", nil, "sk")
    rescue ArgumentError => e
      set = true
    end
  ...
  def test_crypto_box_curve25519xsalsa20poly1305_require_secret_key
    set = false
    begin
      TweetNaCl.crypto_box_curve25519xsalsa20poly1305("foo", "bar", "pk", nil)
    rescue ArgumentError => e
      set = true
    end
  ...
  def test_crypto_box_curve25519xsalsa20poly1305_nonce_not_correct_length
    set = false
    begin
      TweetNaCl.crypto_box_curve25519xsalsa20poly1305("foo", "bar", "pk", "sk")
    rescue ArgumentError => e
      set = true
    end
